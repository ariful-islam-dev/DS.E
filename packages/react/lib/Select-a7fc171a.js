...
const Select = ({ label = "Please Select an option", options = [], onOptionSelected, }) => {
    ...
    return (React.createElement("div", { className: "dse-select" },
        React.createElement("button", { ref: labelRef, className: "dse-select_label", onClick: handleClick },
            ...
            React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "currentColor", className: "dse-select_caret", width: "1rem", height: "1rem" },
...
export { Select as S };
//# sourceMappingURL=Select-a7fc171a.js.map
