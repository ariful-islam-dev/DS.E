...
const Select = ({ label = "Please Select an option", options = [], onOptionSelected, }) => {
    ...
    return (React.createElement("div", { className: "dse-select" },
        ...
        isOpen && (React.createElement("ul", { style: { top: overlayTop }, className: "dse-select_overlay" }, options.map((option, index) => (React.createElement("li", { key: option.value, onClick: () => handleOptionClick(option, index) }, option.label)))))));
};

export { Select as S };
//# sourceMappingURL=Select-8477ab8b.js.map
